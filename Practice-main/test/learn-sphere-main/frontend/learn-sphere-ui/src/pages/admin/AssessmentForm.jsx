...
export default function AssessmentForm({ courseId, onSaved }) {
  ...
  const handleAddOrUpdate = () => {
    ...
    if (editIdx !== null) {
      setQuestions((qs) =>
        qs.map((q, i) => (i === editIdx ? { ...current } : q)),
      );
      setEditIdx(null);
    } else {
  ...
  if (loading)
    return (
      <div style={{ color: "#fff", padding: 32 }}>Loading assessment...</div>
    );
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setMeta((p) => ({ ...p, timeLimitMinutes: +e.target.value }))
              }
              style={{
                width: "100%",
                background: "rgba(255,255,255,0.06)",
          ...
          <div>
            ...
            <input
              ...
              min={0}
              max={100}
              value={meta.passingScorePercentage}
              onChange={(e) =>
                setMeta((p) => ({
                  ...p,
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setMeta((p) => ({ ...p, maxAttempts: +e.target.value }))
              }
              style={{
                width: "100%",
                background: "rgba(255,255,255,0.06)",
          ...
          <div>
            ...
            <input
              ...
              min={1}
              placeholder="e.g. 7"
              value={meta.accessDurationDays}
              onChange={(e) =>
                setMeta((p) => ({ ...p, accessDurationDays: e.target.value }))
              }
              style={{
                width: "100%",
                background: "rgba(255,255,255,0.06)",
          ...
          {["MCQ", "MultipleSelect"].map((t) => (
            <button
              ...
              style={{
                padding: "6px 16px",
                borderRadius: 20,
                border: `2px solid ${current.type === t ? "#6366f1" : "var(--border)"}`,
                background: current.type === t ? "#6366f1" : "transparent",
                color: "#fff",
                fontWeight: current.type === t ? "bold" : "normal",
                cursor: "pointer",
                fontSize: 12,
              }}
            >
              ...
              >
                <div
                  style={{
                    ...
                    width: 16,
                    height: 16,
                    borderRadius: current.type === "MCQ" ? "50%" : 4,
                ...
                {isCorrect && (
                  ...
                  >
                    {current.type === "MCQ" ? "[CORRECT]" : "[✓ CORRECT]"}
                  </span>
                )}
              </div>
            );
            ...
            >
              <div>
                ...
                <p style={{ fontSize: 11, marginTop: 4, opacity: 0.7 }}>
                  [{q.type}] Correct:{" "}
                  {q.correctIndices
                    .map((ci) => q.options[ci] || `Option ${ci + 1}`)
                    .join(", ")}
                </p>
              </div>
              <div
